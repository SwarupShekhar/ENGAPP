...
const realtime_audio_gateway_1 = require("./realtime-audio.gateway");
...
exports.LivekitModule = LivekitModule = __decorate([
    (0, common_1.Module)({
        imports: [config_1.ConfigModule, integrations_module_1.IntegrationsModule, sessions_module_1.SessionsModule, azure_module_1.AzureModule],
        controllers: [livekit_controller_1.LivekitController],
        providers: [livekit_service_1.LivekitService, realtime_audio_gateway_1.RealtimeAudioGateway],
