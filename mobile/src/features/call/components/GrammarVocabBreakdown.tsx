    ...
    <BlurView intensity={20} tint="dark" style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            setExpandedSection(expandedSection === "grammar" ? null : "grammar")
          }
        >
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            setExpandedSection(expandedSection === "vocab" ? null : "vocab")
          }
        >
          <View style={styles.headerLeft}>
            <Text style={styles.sectionIcon}>📖</Text>
        ...
        {expandedSection === "vocab" && (
          <View style={styles.expandedContent}>
              ...
              <View style={styles.statCard}>
                <Text style={styles.statNumber}>
                  {vocabulary.word_count > 0
                    ? Math.round(
                        (vocabulary.unique_words / vocabulary.word_count) * 100,
                      )
                    : 0}
                  %
                </Text>
            ...
            {Object.keys(vocabulary.repetitions).length > 0 && (
              <View style={styles.subsection}>
                <Text style={styles.subsectionTitle}>Repeated Words ⚠️</Text>
                {Object.entries(vocabulary.repetitions).map(
                  ([word, count], index) => (
