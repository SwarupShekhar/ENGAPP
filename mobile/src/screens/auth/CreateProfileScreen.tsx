...
function GoalChip({
  ...
  return (
    ...
    >
      ...
      />
      <Text
        style={[styles.goalChipText, selected && styles.goalChipTextSelected]}
      >
        {label}
      </Text>
      {selected && (
...
export default function CreateProfileScreen({ navigation, onFinish }: any) {
  ...
  const canProceed = () => {
    switch (step) {
      case 0:
        return name.trim().length > 0 && ageRange && nativeLanguage;
      case 1:
        return !!goal;
      case 2:
      ...
      <View style={styles.genderGrid}>
        {[
          ...
          <TouchableOpacity
            ...
            style={[
              styles.genderCard,
              gender === g.key && styles.genderCardSelected,
            ]}
          >
            <Ionicons
              name={g.icon as any}
  ...
  const renderStep3 = () => (
    <View style={styles.stepContent}>
      ...
      {interests.length > 0 && interests.length < 3 && (
        <Text style={styles.hintText}>Select {3 - interests.length} more</Text>
      )}
    </View>
  );
      ...
      <View style={styles.footer}>
        <TouchableOpacity
          ...
          style={[
            ...
            !canProceed() && step !== 2 && styles.buttonDisabled,
          ]}
          onPress={handleNext}
          activeOpacity={0.8}
        >
