        ...
        <SafeAreaView style={{ flex: 1 }} edges={["bottom"]}>
          ...
          <ScrollView contentContainerStyle={styles.content}>
            <Text style={styles.description}>
              Connect in a private session with another learner for focused
            ...
            <View style={styles.warningBox}>
              ...
              <Text style={styles.warningText}>
                Using English throughout the call is required to help both
                learners improve. Be respectful!
              </Text>
            </View>
...
const getStyles = (theme: any) =>
  StyleSheet.create({
    ...
    container: {
      ...
      height: "80%", // Larger height as requested to fit all options comfortably
      width: "100%",
      ...Platform.select({
        ios: {
          shadowColor: "#000",
    ...
    header: {
      ...
      marginBottom: 0, // Content handles its own top padding
    ...
    content: {
      paddingHorizontal: theme.spacing.l,
      paddingTop: theme.spacing.m, // Added to separate from header
      paddingBottom: 40,
      flexGrow: 0, // Don't force growth to avoid unnecessary scrolling
    },
    description: {
    ...
    row: {
      flexDirection: "row",
      gap: theme.spacing.m,
      marginBottom: theme.spacing.l, // 24px spacing from next section
    },
    typeBtn: {
      flex: 1,
      flexDirection: "row",
    ...
    aiTutorLink: {
      ...
      alignItems: "center",
      gap: 6,
      marginTop: 0, // Rely on margin from actionBtn
