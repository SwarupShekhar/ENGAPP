...
export default function ProfileHeader({ user, stats, reliabilityScore, onSettingsPress }: Props) {
    ...
    return (
        <LinearGradient
            ...
            style={[styles.gradientContainer, { paddingTop: Math.max(insets.top, 20) + 10 }]}
        >
                ...
                <View style={styles.headerTop}>
                    <View style={styles.userInfo}>
                        ...
                        <View style={styles.nameContainer}>
                            <Text style={styles.name} numberOfLines={1}>{user?.firstName || 'Learner'}</Text>
