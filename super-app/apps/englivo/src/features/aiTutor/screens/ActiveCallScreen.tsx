...
import { generateReport, saveSession } from "../../../api/aiTutor";
import { TutorMessage, SessionReport } from "../../../types/aiTutor";
  ...
  const ScoreBar = ({
    ...
    <View style={styles.scoreRow}>
      ...
      <View style={styles.scoreBarBg}>
        <View
          style={[styles.scoreBarFill, { width: `${score}%`, backgroundColor: color }]}
        />
      </View>
