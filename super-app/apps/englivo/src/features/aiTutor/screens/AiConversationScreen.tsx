...
import { transcribeAudio, sendMessage, textToSpeech } from "../../../api/aiTutor";
import { VoiceLoopState, TutorMessage } from "../../../types/aiTutor";
...
export default function AiConversationScreen() {
  ...
  const stopAndProcess = async () => {
    ...
    try {
      ...
      const { reply, audioBase64 } = await sendMessage({ message: transcript, history });

      // TTS if no audio returned inline
