...
export default function LoginScreen({ navigation }: any) {
  ...
  const handleGoogleAuth = async () => {
    try {
      ...
      const msg = err.errors?.[0]?.message || "Google sign-in failed.";
      Alert.alert("Error", msg);
    } finally {
      setLoading(false);
    }
        ...
        >
          <View style={styles.logoContainer}>
            ...
            <Text style={styles.subText}>
              {isSignUpMode
                ? "Start your Englivo journey"
                : "Login to continue with Englivo"}
            </Text>
          </View>
          ...
          <View style={styles.formContainer}>
            {!pendingVerification ? (
              <>
                ...
                >
                  <LinearGradient
                    colors={theme.colors.gradients.secondary as any}
                    start={{ x: 0, y: 0 }}
                    end={{ x: 1, y: 0 }}
